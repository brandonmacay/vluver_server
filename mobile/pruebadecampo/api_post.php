        ...
        case 'uploadpic':
            ...
            if(isset($_FILES['fileToUpload']['name']) && isset($_POST['userid'])){
                ...
                try{
                    ...
                    $IMAGE_NAME = mt_rand() . $_FILES['fileToUpload']['name'];
                    ...
                    if ($_POST['condicioncero'] == 0){
                        $postmain = $db->insert_post($_POST['userid'], $_POST['foldername'], $_POST['description']);
                        if ($postmain){
                            $response['error'] = false;
                            $response['message'] = 'Post subido!';

                        }else{
                            $response['message'] = 'Post no fue subido :(';
                            $response['error'] = true;
                        }
                    }
                    ...
                    $response['error'] = true;
                    $response['message'] = 'Los archivos no pudieron subirse';
                }
